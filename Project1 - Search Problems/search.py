...
#############################################################################
    ...
    while open_set:
        ...
        child = [(current_row - 1, current_col),
                ...
                if child_node not in closed_set and child_node not in open_set:
                    if child_node == goal:
                        ...
                        while path_list[-1] != start: 
                            print('The parent node is', path_storage[path_list[-1]])                                                              
...
#############################################################################
    ...
    while open_set:
        ...
        closed_set.add(node_current)
        current_row, current_col = node_current
        child = [((current_row + 1, current_col), v + costFn((current_row + 1, current_col))),
                ((current_row, current_col - 1), v + costFn((current_row, current_col - 1))),
                ((current_row - 1, current_col), v + costFn((current_row - 1, current_col))),
                ((current_row, current_col + 1), v +costFn((current_row, current_col + 1)))]
            ...
            if child_node not in obstacles and child_row >= 0 and child_col >= 0 and child_row < n_rows and child_col < n_cols:
                ...
                if child_node not in closed_set and child_node not in open_set:
                    if child_node == goal:
                        ...
                        path_storage[child_node] = node_current
                # elif node in open_set and open_set.get(child_node) > cost:
...
#############################################################################
    ...
    while open_set:
        ...
        child = [((current_row + 1, current_col), cost_child + costFn((current_row + 1, current_col)) + heuristic(current_row + 1, current_col)),
                ((current_row, current_col - 1), cost_child + costFn((current_row, current_col - 1)) + heuristic(current_row, current_col - 1)),
                ((current_row - 1, current_col), cost_child + costFn((current_row - 1, current_col)) + heuristic(current_row - 1, current_col)),
                ((current_row, current_col + 1), cost_child +costFn((current_row, current_col + 1)) + heuristic(current_row, current_col + 1))]
